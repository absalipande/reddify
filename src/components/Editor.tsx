...
export const Editor: React.FC<EditorProps> = ({ subredditId }) => {
  ...
  // ref and state decalrations to keep track of the initializeEditor
  ...
  // Check for form validation errors and display toast messages
  useEffect(() => {
  ...
  // Initialize the editor and set focus on the title input field
  useEffect(() => {
    const init = async () => {
